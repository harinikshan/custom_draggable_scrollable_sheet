...
class CustomDraggableScrollableController {
...
class _DraggableScrollableSheetScrollController extends ScrollController {
  ...
  _DraggableScrollableSheetScrollPosition createScrollPosition(
    ...
    return _DraggableScrollableSheetScrollPosition.DraggableScrollableSheetScrollPosition(
      physics: physics,
      context: context,
...
class _DraggableScrollableSheetScrollPosition
  ...
  _DraggableScrollableSheetScrollPosition.DraggableScrollableSheetScrollPosition({
    ScrollPhysics physics,
    ScrollContext context,
  ...
  _DraggableScrollableSheetScrollPosition(this.getExtent);
...
///
/// This is just a wrapper on top of [CustomDraggableScrollableController]. It is
